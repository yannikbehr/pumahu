...
\begin{abstract} % abstract
    ...
    non-linear Kalman Smoother. Our method accounts for the, in parts large,
    ...
    Mt. Ruapehu's Crater Lake, New Zealand, between 2016 and 2022. Time-frequency
    analysis of the heat input rate shows dominant periods of heating cycles
    ranged between 100 - 250 days. Some years are dominated by shorter cycles
    and others by longer cycles which potentially points to changes in the
    magmatic heat supply and the hydrothermal system.
\end{abstract}
